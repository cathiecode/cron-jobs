...
__export(main_exports, {
  pickPageIdsWithTags: () => pickPageIdsWithTags
});
module.exports = __toCommonJS(main_exports);
var import_client = __toESM(require_src(), 1);
var import_fs = require("fs");
var settings = JSON.parse((0, import_fs.readFileSync)("./settings.json", "utf-8"));
var notion = new import_client.Client({ auth: process.env.NOTION_KEY });
...
async function* pickPageIdsWithTags(tags) {
